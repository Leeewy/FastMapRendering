...
import com.lewy.fastermaprendering.R;
 ...
 */
public class MyDefaultClusterRenderer<T extends ClusterItem> implements ClusterRenderer<T> {
    private static final boolean SHOULD_ANIMATE = Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB;
    private GoogleMap mMap;
    private IconGenerator mIconGenerator;
    private FastClusterManager<T> mClusterManager;
    ...
    public MyDefaultClusterRenderer(Context context, GoogleMap map, FastClusterManager<T> clusterManager, boolean mManyMarkers) {
        initDefaultClusterRenderer(context, map, clusterManager, mManyMarkers);
    }

    public MyDefaultClusterRenderer(Context context, GoogleMap map, FastClusterManager<T> clusterManager) {
        initDefaultClusterRenderer(context, map, clusterManager, false);
    }

    private void initDefaultClusterRenderer(Context context, GoogleMap map, FastClusterManager<T> clusterManager, boolean mManyMarkers) {
        mMap = map;
    ...
    private class RenderTask implements Runnable {
        ...
        public void run() {
            ...
            if (MyDefaultClusterRenderer.this.mClusters != null && SHOULD_ANIMATE) {
                existingClustersOnScreen = new ArrayList<Point>();
                for (Cluster<T> c : MyDefaultClusterRenderer.this.mClusters) {
            ...
            mMarkers = newMarkers;
            MyDefaultClusterRenderer.this.mClusters = clusters;
            mZoom = zoom;
